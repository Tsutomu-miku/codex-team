...
1. First identify the user's goal: inspect state, inspect current usage, compare accounts, add a new login, save the current login, switch accounts, launch Desktop, watch quota behavior, set up shell completion, or explain command behavior.
